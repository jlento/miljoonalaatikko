...
Message _Waiting for Server Connection_ should now show up, and Taito-shell terminal window should display the node name and port number _Accepting connection(s): c765:9454_.
