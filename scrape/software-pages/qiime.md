...
-     [*parallel\_assign\_taxonomy\_rdp.py*    –   Parallel   taxonomy
    assignment using RDP]
...
-    [*parallel\_multiple\_rarefactions.py* –  Parallel multiple  file
    rarefaction]
-    [*parallel\_pick\_otus\_blast.py*  –  Parallel  pick  otus  using
    BLAST]
-   [*parallel\_pick\_otus\_sortmerna.py*  – Parallel pick  otus using
    SortMeRNA]
-    [*parallel\_pick\_otus\_trie.py* –  Parallel  pick  otus using  a
    trie]
