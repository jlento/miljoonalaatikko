...
The listing  tells us that the  size of the file  is approximately 1,5
...
This created an new  7z-compressed file: project\_3\_backup.7z. The 7z
...
The  output directory  for the  extracted  files can  be defined  with
