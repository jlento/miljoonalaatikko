...
/**
 * heap_decrease - down heapify starting form given element
 * @h: heap to update
 * @data: pointer to element which value has decreased and needs to be down-heapified
 *
 * Requires searching the element in the heap array.
 *
 * Complexity: O(n)
 */
void heap_decrease(struct heap *h, void *data);
